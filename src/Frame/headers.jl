...
==(a::HeadersFrame, b::HeadersFrame) =
    ...
    (isnothing(a.exclusive) || a.exclusive == b.exclusive) &&
    (isnothing(a.exclusive) || a.dependent_stream_identifier == b.dependent_stream_identifier) &&
    (isnothing(a.exclusive) || a.weight == b.weight) &&
